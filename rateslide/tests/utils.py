...
from rateslide.models import Case, CaseInstance, CaseList, Answer, Question, QuestionItem, UserCaseList, AnswerAnnotation


def PopulateAnswers(count):
    cl = CaseList.objects.get(pk=1)
    case = Case.objects.create(Name='Exam case generated 1', Caselist=cl, Introduction='Test')
    ...
    for ans in range(count):
        ...
        ucl = UserCaseList.objects.create(User=user, CaseList=cl, Status=UserCaseList.ACTIVE)
